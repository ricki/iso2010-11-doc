...
Para elegir tanto los valores de prueba como los casos de pruebas de los casos interesantes se ha analizado el comportamiento de este método (mediante caja blanca). Después de analizar el método nos hemos dado cuenta de que sólo pude darse la excepción de NullPointerException.

Esta comprobación es local, por ello si se lanza alguna excepción de las anteriores, no se informará de que te quieren atacar.
